  ...
  return (
    <main>
      <div className="flex flex-wrap items-baseline justify-between gap-3">
        <h1 className="text-xl font-semibold text-stone-900">Mapa</h1>
      ...
      <p className="mt-3 flex items-start gap-2 rounded-lg border border-atrato-100 bg-atrato-50 px-4 py-3 text-sm text-stone-800">
      ...
      {sinUbicar.length > 0 && (
        <p className="mt-3 flex items-start gap-2 rounded-lg border border-barro-200 bg-white px-4 py-3 text-sm text-stone-800">
      ...
      <section className="mt-8">
        <h2 className="font-semibold text-stone-900">Comunidades</h2>
          ...
          {datos.comunidades.map((c) => {
            ...
            return (
              <li key={c.id} className="flex flex-wrap items-baseline gap-x-2 px-4 py-3 text-sm">
                ...
                <span className="text-stone-500">{c.municipio}</span>
      ...
      <section className="mt-8">
        <h2 className="font-semibold text-stone-900">Tramos de esta temporada</h2>
        <ul className="mt-3 divide-y divide-stone-200 rounded-lg border border-barro-200 bg-white">
          {datos.tramos.map((t) => (
            <li key={t.clave} className="flex flex-wrap items-baseline gap-x-2 px-4 py-3 text-sm">
              ...
              <span className="text-stone-600">{etiquetaTramo(t)}</span>
              {!t.activa && (
